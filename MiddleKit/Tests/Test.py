...
class Test:
	...
	def readArgs(self, args):
		if len(args)>1:
			...
			self._modelNames = 'MKBasic MKNone MKString MKDateTime MKDefaultMinMax MKTypeValueChecking MKInheritance MKInheritanceAbstract MKList MKObjRef MKObjRefReuse'.split()
