...
/* ==================================================================================
The rest of this file is just for reference.  It's the python marshal code.

Just in case we need to implement marshalling for another data type.
...
//OK to here
//I need to be able to write the following objects:
//   Dictionary
//   String
//   Long (needed to write a dictionary), there are no marshaled INTs, they are all converted to Long
//  Basically, all the actual writing I need is already done!
