...
# 2000-06-01
#
# This is a slight customization of Python's standard module SocketServer.
# This version counts the number of requests through an attribute 'num_requests'.
# We should get this rolled into Python.
#
...
class TCPServer:
    ...
    def __init__(self, server_address, RequestHandlerClass):
        ...
        self.num_requests = 0 # @@ 2000-06-01 ce
    ...
    def handle_request(self):
        ...
        if self.verify_request(request, client_address):
            try:
                self.num_requests = self.num_requests + 1 # @@ 2000-06-01 ce
