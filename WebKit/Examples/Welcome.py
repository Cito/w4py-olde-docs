...
class Welcome(ExamplePage):
	...
	def writeContent(self):
		...
		<ul>
			...
			<li> The <b>Admin</b> context is particularly interesting because it takes you to the administrative pages for the WebKit AppServer where you can review logs, configuration, plug-ins, etc.
